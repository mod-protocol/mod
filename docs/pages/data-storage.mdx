...
1. The Poll Mod wants to store poll metadata, such as when the poll ends, the question, and the choices.
2. The Poll Mod collects the information via a form, and POSTs it to the backend
