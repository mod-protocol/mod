...
Mod is a standard for creating Embedded Modules. Mod currently only supports the Farcaster protocol, and Mods can be one of two kinds: Mods for creating content, or Mods for displaying rich embeds.
