...
Mod is a standard for creating Mods. Mod currently only supports the Farcaster protocol, and Mods can be one of two kinds: Mods for creating content, or Mods for displaying rich embeds.
...
Mod may make it possible for future Miniapp creators to token gate access to Mods, as well as the ability for creators to earn a share of transactions facilitated by their Mods.
