...
We’re deeply passionate about this problem because social is the most broken part of the internet, and despite that, the internet is still the greatest social technology of all time.
If we want a prosperous and free internet, we need to reduce the barriers for people to create new social experiences, and the best shot at succeeding we have today is through decentralized social protocols.
Mini-apps are a lower barrier and more accessible medium for people to build new social experiences in a way that is easy and has low barriers for adoption.
