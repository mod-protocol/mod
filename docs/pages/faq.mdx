...
In the first phase, all first party Mods will be available to end users, with integrating apps having the control over which Mods to use in their apps.
As the number of Mods grows, we will have Mods designed to be installed in channels by their community leads.
We will also have a way for users to opt into Mods they want, by minting the Mod.
